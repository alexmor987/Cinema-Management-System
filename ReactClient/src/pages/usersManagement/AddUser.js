...
function AddUserComp() {
  const [userData, setUserData] = useState({email:"",fname : "", lname : "",username:"",sessiontime:0})
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} >
                <TextField
                  ...
                  onChange={event => setUserData({...userData, sessiontime :event.target.value})}
                />
              </Grid>
              <Grid item xs={12} >
                <TextField
